        ...
        <div>
            ...
            <div className="relative w-3/4 mx-auto mt-20 shadow-md" style={{ maxWidth: '1040px' }}>
                ...
                <div className="bg-green-600 bg-opacity-20 rounded-lg flex">
                    <img src={attraction} alt="attraction" className="max-w-200 h-auto ml-8 mt-20 mb-7" style={{ width: '250px', height: '220px',filter: 'drop-shadow(10px 7px 10px yellow)' }} />
            ...
            <div className="relative w-3/4 mx-auto mt-20 shadow-md" style={{ maxWidth: '1040px' }}>
                ...
                <div className="bg-green-600 bg-opacity-20 rounded-lg flex">
                    <img src={food} alt="food" className="max-w-200 h-auto ml-8 mt-20 mb-5" style={{ width: '250px', height: '250px',filter: 'drop-shadow(10px 7px 10px yellow)' }} />
                    <div className="flex flex-col items-start ml-8 mr-8 mt-16">
                        <p className="text-black text-lg mb-8 font-istok">
            ...
            <div className="relative w-3/4 mx-auto mt-20 shadow-md" style={{ maxWidth: '1040px' }}>
                ...
                <div className="bg-green-600 bg-opacity-20 rounded-lg">
                    <div className="flex items-start">
                        <img src={mask} alt="mask" className="max-w-200 h-auto mt-8 ml-8 mb-5" style={{ width: '200px', height: '250px',filter: 'drop-shadow(10px 7px 10px orange)' }} />
                        <div className="flex flex-col items-start ml-8 mr-8 mt-16">
                            <p className="text-black text-lg mb-8 font-istok">
            ...
            <div className="relative w-3/4 mx-auto mt-20 mb-20 shadow-md" style={{ maxWidth: '1040px' }}>
                ...
                <div className="bg-green-600 bg-opacity-20 rounded-lg flex">
                    <img src={emergency} alt="emergency" className="max-w-200 h-auto ml-8 mt-5" style={{ width: '250px', height: '300px',filter: 'drop-shadow(10px 7px 10px purple)'}} />
                    <div className="flex flex-col items-start ml-8 mr-8 mt-16">
                        < p className="text-black text-lg mb-8 font-istok">
                        "Discover the closest emergency locations with TravelGuru. Whether you need urgent medical assistance, police support, or a nearby fire station, our platform utilizes advanced mapping technology to pinpoint emergency services near you. Stay prepared and informed during critical moments with our user-friendly interface, providing peace of mind at your fingertips."                        </p>
                        <button className="absolute bottom-8 right-8 bg-lime-400 shadow-lg text-black py-4 px-8 rounded font-bold ">Explore</button>
                    </div>
                </div>
            </div>
